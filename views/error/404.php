        ...
        <section class="py-8 px-4 text-center">
            <div class="max-w-auto mx-auto">
                <div class="md:max-w-lg mx-auto">
                    <svg class="fill-current text-blue-50" viewBox="0 0 445 202" xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 class="mt-8 uppercase text-xl lg:text-5xl font-black text-blue-300">Ой, запрашиваемая страница не найдена</h2>
                <p class="mt-6 uppercase text-sm lg:text-base text-blue-400">Запрашиваемая вами страница удалена или временно недоступна.</p>
                <a href="/" class="mt-6 bg-green-700 transition-colors duration-300 hover:bg-green-800 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-md">Вернутся на сайт</a>
            </div>
        </section>
    </div>
